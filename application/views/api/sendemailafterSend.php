                  ...
                  <table width="630" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                     <tr>
                       ...
                       <td align="center">
                        <h1 style="font-family:HelveticaNeue-Light,arial,sans-serif;font-size:48px;color:#404040;line-height:48px;font-weight:bold;margin:0;padding:0">Transaksi anda telah selesai</h1>
                      </td>
                      <td width="25"></td>
                    </tr>
                    <tr>
                     ...
                     <p style="color:#404040;font-size:16px;line-height:22px;font-weight:lighter;padding:0;margin:0">
											 Terimakasih telah mempercayai kami sebagai partner anda, transaksi anda telah berhasil dan kami telah kirim pesanan anda.
                      </p>
											<br/>
                    ...
                    <td colspan="4">
                      <div style="width:100%;text-align:center;margin:30px 0">
                        <table align="center" cellpadding="0" cellspacing="0" style="font-family:HelveticaNeue-Light,Arial,sans-serif;margin:0 auto;padding:0">
                          <tbody>
                           <tr>
                            <td align="center" style="margin:0;text-align:center"><a href="<?php echo base_url() ?>" style="font-size:21px;line-height:22px;text-decoration:none;color:#ffffff;font-weight:bold;border-radius:2px;background-color:#0096d3;padding:14px 40px;display:block;letter-spacing:1.2px" target="_blank">NO RESI : <?php echo $invoice ?></a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
