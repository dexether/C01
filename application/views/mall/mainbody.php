...
<div class="container">
        ...
        <div class="col-md-4">
            <div class="product">
                <ul class="product-labels">
                    <li><?php echo $value['promo_alias'] ?></li>
                </ul>
                ...
                <div class="product-caption">
                    ...
                    <div class="product-caption-price"><span class="product-caption-price-new"><?php echo $this->format->set_rp($value['prod_price']) ?></span>
                    </div>
    ...
    <div class="row" data-gutter="15">
        ...
        <div class="gap"></div>
        <div class="container">
            <h3 class="widget-title-lg"><?php echo $this->lang->line('main_best_signal'); ?></h3>
            <div class="row row-sm-gap" data-gutter="10">
                <div class="col-md-4">
                    <div class="product ">
                        <ul class="product-labels"></ul>
        ...
        <div class="gap"></div>
        <div class="container">
            <h3 class="widget-title-lg"><?php echo $this->lang->line('main_best_seminar'); ?></h3>
            <div class="row row-sm-gap" data-gutter="10">
                <div class="col-md-3">
                    <div class="product ">
                        <ul class="product-labels">
