        ...
        <div class="col-md-4">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$124</span><span class="product-caption-price-new">$75</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <div class="product-caption-price"><span class="product-caption-price-old">$135</span><span class="product-caption-price-new">$95</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$110</span><span class="product-caption-price-new">$44</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Citizen NightHawk EcoDrive Chronograph Black Ion-plated...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$86</span><span class="product-caption-price-new">$78</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>5 left</li>
                        <li>Free Shipping</li>
    ...
    <div class="row row-sm-gap" data-gutter="10">
        <div class="col-md-6">
            <div class="banner" style="background-color:#9C7B60;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/5-i.png" alt="Image Alternative text" title="Image Title" style="bottom: -8px; right: 11px; width: 238px;" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="banner" style="background-color:#DF643B;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/6-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -20px; width: 326px;" />
            </div>
        </div>
    </div>
    <div class="gap"></div>
        ...
        <div class="col-md-4">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Beats by Dre urBeats In-Ear Noise Isolating Headphones with In-line Control</h5>
                    <div class="product-caption-price"><span class="product-caption-price-new">$52</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>4 left</li>
                        <li>Free Shipping</li>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$86</span><span class="product-caption-price-new">$52</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>1 left</li>
                        <li>Free Shipping</li>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Citizen NightHawk EcoDrive Chronograph Black Ion-plated...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$137</span><span class="product-caption-price-new">$83</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Vintage Men's Canvas Shoulder Bag Casual School Military Messenger Travel Bag</h5>
                    <div class="product-caption-price"><span class="product-caption-price-new">$57</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$132</span><span class="product-caption-price-new">$53</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
    ...
    <div class="row row-sm-gap" data-gutter="10">
        <div class="col-md-4">
            <div class="banner" style="background-color:#AC7751;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/10-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -3px; width: 122px;" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="banner" style="background-color:#3C3B42;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/11-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -5px; width: 102px;" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="banner" style="background-color:#58412A;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/12-i.png" alt="Image Alternative text" title="Image Title" style="bottom: -5px; right: -5px; width: 180px;" />
            </div>
        </div>
    </div>
</div>
...
<div class="slider-item-sm" style="background-image:url(<?php echo base_url('assets') ?>/img/1200x500.png);">
    <div class="container">
        <div class="slider-item-inner">
            ...
            <img class="slider-item-img" src="<?php echo base_url('assets') ?>/img/test_slider/5-i.png" alt="Image Alternative text" title="Image Title" style="right: 0; bottom: 0; width: 33%;" />
        </div>
    </div>
</div>
<div class="gap"></div>
        ...
        <div class="col-md-3">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-new">$117</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>3 left</li>
                        <li>Free Shipping</li>
        ...
        <div class="col-md-3">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Citizen NightHawk EcoDrive Chronograph Black Ion-plated...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$138</span><span class="product-caption-price-new">$56</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
    ...
    <div class="row row-sm-gap" data-gutter="10">
        <div class="col-md-4">
            <div class="banner" style="background-color:#72121C;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/7-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -20px;" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="banner" style="background-color:#4172FF;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/8-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -5px;" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="banner" style="background-color:#444C50;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/9-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -10px; width: 180px;" />
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-3">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Vintage Men's Canvas Shoulder Bag Casual School Military Messenger Travel Bag</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$93</span><span class="product-caption-price-new">$47</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$125</span><span class="product-caption-price-new">$75</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Beats by Dre urBeats In-Ear Noise Isolating Headphones with In-line Control</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$60</span><span class="product-caption-price-new">$18</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>1 left</li>
                        <li>Free Shipping</li>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Citizen NightHawk EcoDrive Chronograph Black Ion-plated...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$142</span><span class="product-caption-price-new">$86</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$134</span><span class="product-caption-price-new">$121</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Citizen NightHawk EcoDrive Chronograph Black Ion-plated...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-new">$115</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
    ...
    <div class="row row-sm-gap" data-gutter="10">
        <div class="col-md-6">
            <div class="banner" style="background-color:#0290C7;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/13-i.png" alt="Image Alternative text" title="Image Title" style="bottom: -8px; right: 0; width: 188px;" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="banner" style="background-color:#F22E18;">
                ...
                <img class="banner-img" src="<?php echo base_url('assets') ?>/img/test_banner/14-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: 0; width: 246px;" />
            </div>
        </div>
    </div>
    <div class="gap"></div>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Beats by Dre urBeats In-Ear Noise Isolating Headphones with In-line Control</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$105</span><span class="product-caption-price-new">$42</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>2 left</li>
                        <li>Free Shipping</li>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Vintage Men's Canvas Shoulder Bag Casual School Military Messenger Travel Bag</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$60</span><span class="product-caption-price-new">$42</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Citizen NightHawk EcoDrive Chronograph Black Ion-plated...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$143</span><span class="product-caption-price-new">$86</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Vintage Men's Canvas Shoulder Bag Casual School Military Messenger Travel Bag</h5>
                    <div class="product-caption-price"><span class="product-caption-price-old">$135</span><span class="product-caption-price-new">$68</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="product product-sm-left ">
                ...
                <div class="product-caption">
                    ...
                    <h5 class="product-caption-title">Samsung N900 Galaxy Note 3 32GB Verizon Wireless Black...</h5>
                    <div class="product-caption-price"><span class="product-caption-price-new">$130</span>
                    </div>
                    <ul class="product-caption-feature-list">
                        <li>Free Shipping</li>
                    </ul>
    ...
    <div class="row row-sm-gap" data-gutter="10">
        <div class="col-md-2">
            <a class="banner-category" href="#">
                <img class="banner-category-img" src="<?php echo base_url('assets') ?>/img/100x100.png" alt="Image Alternative text" title="Image Title" />
                <h5 class="banner-category-title">Home &amp; Garden</h5>
                <p class="banner-category-desc">204 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">183 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">607 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">357 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">124 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">496 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">223 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">654 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">262 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">412 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">245 products</p>
            </a>
        </div>
        <div class="col-md-2">
            <a class="banner-category" href="#">
                ...
                <p class="banner-category-desc">375 products</p>
            </a>
        </div>
    </div>
</div>
