...
$_SESSION['page'] = 'tabel_meta_super';
/*==============================
=        Start Coding          =
==============================*/
$commissiondate = "";
...
$query = "SELECT 
        ...
        AND marketing.`group_city` IN ('JKTA1','JKTA2','JKTB','JKTD','JKTE','JKTF','JKTG','BDGA','BDGB','BDGD','LMPA')
...
/*=====  End of Coding  ======*/
$template->display("tabel_meta_super.htm");
