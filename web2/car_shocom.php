...
if (isset($_GET['commissiondate'])) {
    $daritgl = $_GET['commissiondate'];
}
$template->assign("daritgl", $daritgl);
// var_dump($daritgl);
...
/*=====  End of Coding  ======*/
$template->display("car_shocom.htm");
