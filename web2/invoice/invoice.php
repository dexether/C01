...
public function invoiceNumber($invoice)
{
  ...
  $this->SetFont( 'Arial', '', 10);
  $this->SetX($this->lMargin);
  $this->Cell( 0, 10, "INVOICE # = " . $invoice, 0, 0, 'R' );
}
...
function addCols( $tab, $y1, $y2 = null)
{
	global $colonnes;
...
function temporaire( $texte )
{
	...
	public function addJobs($jobs, $terms)
	{
		$this->addCols([
			'Jobs' => 150,
			'Payment Terms' => 50,
	...
	public function addProduct($desc, $total, $subtotal = 0)
	{
		$this->addCols([
			'Description' => 150,
			'Total' => 50,
	...
	public function addSingature()
	{
		$this->SetXY(0, 220);
		// $this->Cell(80);
		$this->SetFont('Times','I');
		$this->Cell(0,0,'Thank you for your business!',0,1,'C');

		$this->SetXY(0, 250);
		// $this->Cell(80);
		$this->SetFont('Times','B', 16);
		$this->Cell(0,0,'Trado Market International PLT- LLP0009899-LGN',0,1,'C');
