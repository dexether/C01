...
$_SESSION['page'] = 'maxwell_demo_logs';
...
$query = "SELECT table_name FROM information_schema.tables WHERE table_schema='maxwell_demo_logs';";
$rows = $DB->execresultset($query);
foreach ($rows as $row) {
...
$query = "SELECT table_name FROM information_schema.tables 
    WHERE table_schema='maxwell_demo_logs' and table_name between ('logs_$datesearch1') and ('logs_$datesearch2') ";
...
if(count($rolldatas)>0){
    ...
    $query = "SELECT id,code,ip,msg,ctm,unused1,unused2 FROM maxwell_demo_logs.logs_$datameta_rollover 
