...
// query here
$query = "SELECT id, cat_alias FROM master_cat WHERE is_active = TRUE ORDER BY cat_alias	ASC";
$result = $DB->execresultset($query);
// var_dump($result);
$template->assign("list_category",$result);

$template->display("mall_admin_product.htm");
