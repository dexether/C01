...
$_SESSION['page'] = 'ar_transfer_goldsaving';
...
foreach($account1 as $key => $rows) {
    ...
    $allaccounts[$key]['wallet'] = "Gold Saving";
}
...
$template->assign("alls", $toaccounts);
...
AND client_aecode.`aecode` = '$user->username'
AND mlm_transaction.`type_transaction` = 'transfer-gold'";
$result = $DB->execresultset($query);
$template->assign("request", $result);
$template->display("ar_transfer_goldsaving.htm");
