<?php /* Smarty version 3.1.27, created on 2016-10-06 14:00:51
         compiled from "/var/www/cabinet-stable/web2/templates/openaccount.htm" */ ?>
<?php
/*%%SmartyHeaderCode:77693291357f5f6a31f7081_22879511%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70aca0b732edb7fd497d900ed9fd054209b3f0c9' => 
    array (
      0 => '/var/www/cabinet-stable/web2/templates/openaccount.htm',
      1 => 1474343347,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '77693291357f5f6a31f7081_22879511',
  'variables' => 
  array (
    'companys' => 0,
    'agent' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57f5f6a32b6113_51586728',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57f5f6a32b6113_51586728')) {
function content_57f5f6a32b6113_51586728 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '77693291357f5f6a31f7081_22879511';
?>
<!DOCTYPE html>
<html>
               ...
               <div class="col-md-12 portlets">
                  <div class="widget">
                     <div class="widget-content padding">
                        <form action="openaccount2.php<?php if ($_smarty_tpl->tpl_vars['agent']->value != false) {?>?redirect=<?php echo $_smarty_tpl->tpl_vars['agent']->value['theurl'];
}?>" class="form-horizontal" id="registerForm" method="post" role="form">
                           <div class="widget-content padding">
                                 ...
                                 <div class="form-group">
                                    <div class="row">
                                       <div class="col-sm-6">
                                          ...
                                          <select class="form-control" id="description1" name="description1" readonly="true" <?php if ($_smarty_tpl->tpl_vars['agent']->value != false) {
}?>>
                                             <option value="Agent" <?php if ($_smarty_tpl->tpl_vars['agent']->value != false) {?>selected<?php }?>>
                                                Agent / Agen
                                             </option>
                                             <option value="Newspaper" <?php if ($_smarty_tpl->tpl_vars['agent']->value == false) {?>selected<?php }?>>
...
" type="text" style=""/>
                                          <input class="form-control hiddenInput" id="agen" name="agen" placeholder="Please enter your agen email" value="<?php if ($_smarty_tpl->tpl_vars['agent']->value != false) {
echo $_smarty_tpl->tpl_vars['agent']->value['email'];
}?>" <?php if ($_smarty_tpl->tpl_vars['agent']->value != false) {?>readonly<?php }?> type="text" style=""/>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group">
