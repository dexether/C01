...
<html lang="en">
    <head> 
        ...
        <title>Apex Regent Program</title>
        ...
        <link rel="shortcut icon" href="templates/home_01/faicon.png">
                        ...
                        <div class="content-box">
                            <h3 class="content-box-header content-box-header-alt bg-default">
                                <span class="icon-separator">
                                    <img src="templates/home_01/faicon.png" alt="MT Apex Regent Program" class="img-responsive">
                                </span>
