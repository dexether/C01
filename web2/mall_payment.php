...
$_SESSION['page'] = 'mall_payment';

// query here
$query = "SELECT master_cmd.`cmd_alias`, cmd, id FROM master_cmd WHERE master_cmd.`type` = 'invoice' ORDER BY cmd ASC";
$result = $DB->execresultset($query);
// var_dump($result);
$template->assign("list_cmd",$result);

$template->display("mall_payment.htm");
