...
$template->display("report_turnover_running_reverse.htm");
...
function fetchStatement2($login, $turnover2, $report_turnover_equity) {
    ...
    if ($turnover2['ikuttampil1'] == 'ya') {
        ...
        foreach ($rows as $row) {
            ...
            // tradeLogReport_Summary_Client("Report_TurnOver_Running-125 : turnover2['rangeturnover']:" . $turnover2['rangeturnover']);
            if ($turnover2['rangeturnover'] <= $default_turnover) {
                $turnover2['ikuttampil2'] = 'ya';
            }
        }
    }//if ($turnover2['ikuttampil'] == 'ya') {
