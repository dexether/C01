    ...
    !function(a) {
        ...
        function H(a, b) {
            var c, e, f, g, h = [], i = [], j = b.firstChild, k = 0, l = a.aoColumns, m = function(a, b, c) {
                ...
                e = l[k], g = d.trim(a.innerHTML), e && e._bAttrSrc ? (f = {display: g}, m(e.mData.sort, f, a), m(e.mData.type, f, a), m(e.mData.filter, f, a), h.push(f)) : h.push(g), k++
            };
            if (j)
                for (; j; )
                    c = j.nodeName.toUpperCase(), ("TD" == c || "TH" == c) && (n(j), i.push(j)), j = j.nextSibling;
            else {
                i = b.anCells;
            ...
            for (c = 0, e = a.aoData.length; e > c; c++)
                if (i = a.aoData[c], !i._aFilterData) {
                    for (g = [], d = 0, f = j.length; f > d; d++)
                        b = j[d], b.bSearchable ? (h = y(a, c, d, "filter"), k[b.sType] && (h = k[b.sType](h)), null === h && (h = ""), "string" != typeof h && h.toString && (h = h.toString())) : h = "", h.indexOf && -1 !== h.indexOf("&") && (uc.innerHTML = h, h = vc ? uc.textContent : uc.innerText), h.replace && (h = h.replace(/[\r\n]/g, "")), g.push(h);
        ...
        function xb(a, b) {
            for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; g > f; f++)
                c = y(a, f, b, "display") + "", c = c.replace(wc, ""), c.length > d && (d = c.length, e = f);
            return e
        }
        function yb(a) {
        ...
        function Ab(a) {
            ...
            for (d.isArray(l) && o(l), m && l.pre && o(l.pre), o(a.aaSorting), m && l.post && o(l.post), b = 0; b < n.length; b++)
                for (i = n[b][0], f = k[i].aDataSort, c = 0, e = f.length; e > c; c++)
                    g = f[c], h = k[g].sType || "string", j.push({src: i, col: g, dir: n[b][1], index: n[b][2], type: h, formatter: Wb.ext.type.order[h + "-pre"]});
            return j
        }
        function Bb(a) {
        ...
        function Tb(a, b) {
            var c = [], d = Sc.numbers_length, e = Math.floor(d / 2);
        ...
        var Wb, Xb, Yb, Zb, $b, _b = {}, ac = /[\r\n]/g, bc = /<.*?>/g, cc = /^[\w\+\-]/, dc = /[\w\+\-]$/, ec = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")", "g"), fc = /[',$Â£â‚¬Â¥%\u2009\u202F]/g, gc = function(a) {
            return a && a !== !0 && "-" !== a ? !1 : !0
        }, hc = function(a) {
            var b = parseInt(a, 10);
            ...
            a[b] !== c && (a[d] = a[b])
        }, sc = /\[.*?\]$/, tc = /\(\)$/, uc = d("<div>")[0], vc = uc.textContent !== c, wc = /<.*?>/g;
        Wb = function(a) {
            this.$ = function(a, b) {
        ...
        var xc = [], yc = Array.prototype, zc = function(a) {
        ...
        Yb = function(a, b) {
            ...
            if (d.isArray(a))
                ...
                e(a);
            this.context = qc(c), b && this.push.apply(this, b.toArray ? b.toArray() : b), this.selector = {rows: null, cols: null, opts: null}, Yb.extend(this, this, xc)
        }, Wb.Api = Yb, Yb.prototype = {concat: yc.concat, context: [], each: function(a) {
            ...
            }, join: yc.join, indexOf: yc.indexOf || function(a, b) {
                ...
                for ("string" == typeof a && (d = b, b = a, a = !1), f = 0, g = n.length; g > f; f++)
                    if ("table" === b)
                        ...
                        for (k = this[f], "column-rows" === b && (j = Fc(n[f], o.opts)), h = 0, i = k.length; i > h; h++)
                            l = k[h], e = "cell" === b ? d(n[f], l.row, l.column, f, h) : d(n[f], l, f, h, j), e !== c && m.push(e);
                if (m.length) {
                    var p = new Yb(n, a ? m.concat.apply([], m) : m), q = p.selector;
            ...
            }, pop: yc.pop, push: yc.push, reduce: yc.reduce || function(a, b) {
                return k(this, a, b, 0, this.length, 1)
            }, reduceRight: yc.reduceRight || function(a, b) {
                return k(this, a, b, this.length - 1, -1, -1)
            }, reverse: yc.reverse, selector: null, shift: yc.shift, sort: yc.sort, splice: yc.splice, toArray: function() {
            ...
            }, unshift: yc.unshift}, Yb.extend = function(a, b, c) {
            ...
            if (d.isArray(a))
                ...
                var f, g, h, i, j = a.split("."), k = xc, l = function(a, b) {
        ...
        var Oc = /^(.+):(name|visIdx|visible)$/, Pc = function(a, b) {
            var c = a.aoColumns, e = mc(c, "sName"), f = mc(c, "nTh");
            return Cc(b, function(b) {
                var g = hc(b);
                if ("" === b)
                    return oc(c.length);
        ...
        var Rc = function(a, b, e) {
            var f, g, h, i, j, k = a.aoData, l = Fc(a, e), m = nc(k, l, "anCells"), n = d([].concat.apply([], m)), o = a.aoColumns.length;
            return Cc(b, function(a) {
                if (null === a || a === c) {
                    for (g = [], h = 0, i = l.length; i > h; h++)
                        for (f = l[h], j = 0; o > j; j++)
                            g.push({row: f, column: j});
                    return g
                }
                return d.isPlainObject(a) ? [a] : n.filter(a).map(function(a, b) {
                    return f = b.parentNode._DT_RowIndex, {row: f, column: d.inArray(b, k[f].anCells)}
                }).toArray()
            })
        };
        ...
        return d.extend(Xb.type.order, {"date-pre": function(a) {
            ...
            }}), d.extend(!0, Wb.ext.renderer, {header: {_: function(a, b, c, e) {
