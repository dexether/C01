...
$_SESSION['page'] = 'ar_admin_payment';

/*====================================
=            Start Coding            =
====================================*/

$query = "SELECT * FROM mlm_payment ORDER BY TxnDate DESC";
$result = $DB->execresultset($query);
$datapaymets = array();
foreach ($result as $key => $rows) {
    $datapayments[] = $rows;
}
$template->assign("datapayments", $datapayments);
/*=====  End of Start Coding  ======*/



$template->display("ar_admin_payment.htm");
