                    ...
                    if (data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                                ...
                                tr.append("<td>" + 
                                    ...
                                    '<button title="Open Position" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalopen" onclick="op('+data[i].mt4login+')"><i class="fa fa-list-ol"></i></button> &nbsp'+
                                    '<button title="Close Position" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalclose" onclick="cp('+data[i].mt4login+')"><i class="fa fa-bar-chart"></i></button> &nbsp'+
                                    '<button title="Margin" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#Modalmargin" onclick="margin('+data[i].mt4login+')"><i class="fa fa-briefcase"></i></button> &nbsp'+
                                "</td>");
