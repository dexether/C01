var AC_Schedule = function() {
    ...
    return {
        ...
        admin: function(accountsearch, no) {
           var url = 'admin_car_schedule.php?accno=' + accountsearch + '&tampil=no';
		...
		admin2: function(Cancel, meta, downline, upline, mail, offer) {
			var url = 'admin_car_schedule_do.php?Cancel=' + Cancel + '&meta=' + meta + '&ACCNO=' + downline + '&accountupline=' + upline + '&email=' + mail + '&offer=' + offer;
            var data = '&ajax_validation=1';
