var car_hitcom_admin = function() {
    ...
    return {
		...
		carimeta: function(commissiondate, commissionhour, todate, tohour) {
            var url = 'tabel_meta_admin.php?commissiondate=' + commissiondate + "&commissionhour=" + commissionhour + "&todate=" + todate+ "&tohour=" + tohour;
		...
		view: function(lihat, commissiondate, commissionhour, todate, tohour) {
			...
			var url = 'tabel_meta_adminsee.php?lihat=' + lihat + "&commissiondate=" + commissiondate + "&commissionhour=" + commissionhour + "&todate=" + todate+ "&tohour=" + tohour;
            var data = '&ajax_validation=1';
