    ...
    return {
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        ...
                        for (var i = 0; i < quick.length; i++) {
                            ...
                            tr.append("<td>" + aw_comm_JS.changetorp(quick[i].subtotal) + "</td>");
                            $('table[id=table-komisi-group] tbody').append(tr);
                        }
                        for (var i = 0; i < response.length; i++) {
                            var uang = aw_comm_JS.changetorp(response[i].amount);
                        ...
                        var subtotal = aw_comm_JS.changetorp(total);
                        $.each(anony, function(key, value) {
                            for (var i = 0; i < value.length; i++) {
                                ...
                                tr.append("<td>" + aw_comm_JS.changetorp(value[i].lot_amount * value[i].lots) + "</td>");
        ...
        generate: function(a) {
            ...
            if (tgl == 'periode') {
                ...
                $.ajax({
                    url: 'aw_comm_generator.php?postmode=mlm_temp',
                    data: formDatas,
                    type: 'POST',
                    dataType: 'JSON',
                    error: function() {
                    ...
                    success: function(response) {
                        ...
                        setTimeout(function() {
                            ...
                            $.ajax({
                                url: 'aw_comm_generator.php?postmode=hitung',
                                data: formDatas2,
                                type: 'POST',
                                dataType: 'JSON',
                                error: function() {
                                ...
                                success: function(res) {
                                    ...
                                    var formDatas2 = $('#ajax-form').serializeArray();
                                    $.ajax({
                                        url: 'aw_comm_generator.php?postmode=wallet',
                                        data: formDatas2,
                                        type: 'POST',
                                        dataType: 'JSON',
                                        error: function() {
