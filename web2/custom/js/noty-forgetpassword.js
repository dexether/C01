function notifyerror(style,position) {
	icon = "fa fa-exclamation";
    $.notify({
        title: 'Reset Password has not succeed',
        text: 'we do not have that email in our database',
...
function notifysuccess(style,position) {
	icon = "fa fa-check";
    $.notify({
