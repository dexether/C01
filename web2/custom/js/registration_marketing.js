var RM = function() {
    ...
    return {
        ...
        addM: function(email, nama, upline, city, telephone_mobile) {
         var url = 'registration_marketing_do.php?email=' + email + '&nama=' + nama + '&upline=' + upline + '&city=' + city + '&telephone_mobile=' + telephone_mobile;
         var data = '&ajax_validation=1';
			      // console.log(email, nama, upline, city, telephone_mobile);     
