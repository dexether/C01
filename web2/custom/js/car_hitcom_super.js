var car_hitcom_superJS = function() {
    ...
    return {
		...
		carimeta: function(commissiondate, commissionhour, todate, tohour) {
            var url = 'tabel_meta_super.php?commissiondate=' + commissiondate + "&commissionhour=" + commissionhour + "&todate=" + todate+ "&tohour=" + tohour;
		...
		view: function(lihat, commissiondate, commissionhour, todate, tohour) {
			...
			var url = 'tabel_meta_superbm.php?lihat=' + lihat + "&commissiondate=" + commissiondate + "&commissionhour=" + commissionhour + "&todate=" + todate+ "&tohour=" + tohour;
            var data = '&ajax_validation=1';
		...
		viewdetail: function(lihat, commissiondate, commissionhour, todate, tohour) {
			      // console.log(lihat, commissiondate, commissionhour, todate, tohour);     
			var url = 'tabel_meta_supersee.php?lihat=' + lihat + "&commissiondate=" + commissiondate + "&commissionhour=" + commissionhour + "&todate=" + todate+ "&tohour=" + tohour;
            var data = '&ajax_validation=1';
