var car_hitcom_bm = function() {
    ...
    return {
		...
		carimeta: function(downline, marem, accountmeta, commissiondate, commissionhour, todate, tohour) {
            var url = 'tabel_meta_bm.php?downline=' + downline + "&accabi=" + marem + "&accmeta=" + accountmeta + "&commissiondate=" + commissiondate + "&commissionhour=" + commissionhour + "&todate=" + todate+ "&tohour=" + tohour;
